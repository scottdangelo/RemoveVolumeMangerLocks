...
# of the REST API
API_VERSION_REQUEST_HEADER = 'X-OpenStack-Cinder-API-Version'
...
class Request(webob.Request):
    ...
    def set_api_version_request(self):
        ...
        Microversions starts with /v2.1, so if a client sends a /v2 URL, then
        ignore the headers and request 2.0 APIs.
        """
